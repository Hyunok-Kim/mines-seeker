...
Popup {
    ...
    Item {
        ...
        Image {
            ...
            source: "images/Splash/cujae.png"
        ...
        Image {
            ...
            fillMode: Image.PreserveAspectFit
            source: "images/Splash/tiger.png"
            sourceSize: Qt.size(width, height);
        }
    ...
    Text {
        id: textCopyright
        text: qsTr("Copyright (c) 2018 Carlos Enrique Perez Sanchez.")
