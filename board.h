...
class Board : public QObject
{
    ...
    Q_PROPERTY(int rows READ getNumberOfColumns NOTIFY numberOfColumnsChanged)
...
public:
    enum BOARDMODE {BEGINNER, MEDIUM, EXPERT, CUSTOM};
    ...
    void setMode(const BOARDMODE &value, int customRows = -1, int customColums = -1, int customMines = -1);
...
private:
    ...
    void triggerSiblings(int row, int column, bool reveal);
    void win();
